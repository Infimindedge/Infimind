...
export function ChallengePanel({ challenge }: ChallengePanelProps) {
  ...
  return (
    <motion.div
      ...
      className="overflow-hidden rounded-container border border-border bg-paper-pure"
    >
      {!hasContent ? (
        ...
        <div className="grid grid-cols-1 divide-y divide-border lg:grid-cols-3 lg:divide-x lg:divide-y-0">
          <div className="flex flex-col p-5 sm:p-6">
            ...
            {challenge.challengeImageFilename ? (
              <div className="mx-auto mt-5 aspect-[4/3] w-[78%] overflow-hidden rounded-lg">
                <Photo
          ...
          <div className="flex flex-col bg-paper-soft/60 p-5 sm:p-6">
